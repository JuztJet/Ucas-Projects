...
class Level4:
    ...
    def create_objects(self):
        ...
        self.block1 = self.block(self.box_width-230, self.box_height+110, 200, 100, self.screen, False, self.dt,0, 0, True, self.box_width-230, self.box_width+150, 385)
        self.block2 = self.block(self.box_width+330, self.box_height+210, 200, 100, self.screen, False, self.dt,0, 0, True, self.box_width+200, self.box_width+560, 390)
        self.block3 = self.block(self.box_width-230, self.box_height+310, 200, 100, self.screen, False, self.dt,0, 0, True, self.box_width-230, self.box_width+150, 310)
